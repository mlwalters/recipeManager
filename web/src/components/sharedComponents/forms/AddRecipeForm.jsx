...
const AddRecipeForm = ({
  categories, onAddRecipeFormSubmit, handleClose,
}) => (
  <Dialog
    open
    fullScreen
  ...
  >
    ...
    <DialogContent>
      ...
      >
        {({
          errors, isValid, touched, dirty, values, resetForm, isSubmitting, handleBlur,
        }) => (
          <Form>
            <Field
              label="Recipe name"
...
AddRecipeForm.defaultProps = {
  categories: [],
  onAddRecipeFormSubmit: undefined,
...
AddRecipeForm.propTypes = {
  ...
  onAddRecipeFormSubmit: PropTypes.func,
